  ...
  if (v630) {
    ...
    const txn5 = await (ctc.sendrecv({
      ...
      sim_p: (async (txn5) => {
        ...
        sim_r.txns.push({
          amt: stdlib.checkedBigNumberify('./index.rsh:146:24:application', stdlib.UInt_max, '50000000000'),
          kind: 'from',
          to: v629,
          tok: v582
          });
        sim_r.txns.push({
          amt: stdlib.checkedBigNumberify('./index.rsh:147:23:application', stdlib.UInt_max, '5000000000'),
          kind: 'from',
          to: v629,
          tok: v583
          });
